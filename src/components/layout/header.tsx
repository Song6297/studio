...
import { Menu, Languages, Globe, LogOut, Building, LayoutDashboard as DashboardIcon, User, ShieldAlert, FileSignature } from 'lucide-react';
...
export function Header() {
  ...
  const navLinks = [
    ...
    { href: '/fir-generator', label: 'FIR Generator'},
